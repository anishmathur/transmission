...
insert into transmission_line(name,capacity) values ('Northern',10)
insert into generation(name, generation_level, transmission_line_id) values ('KH1', 10.0, 2)
insert into generation(name, generation_level, transmission_line_id) values ('KH2', 20.0, 2)